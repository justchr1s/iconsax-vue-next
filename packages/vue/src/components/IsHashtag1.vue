...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M8.05 10.14v1.16h3.26V8.05h-1.16c-1.16 0-2.1.94-2.1 2.09zM8.05 13.86c0 1.15.94 2.09 2.09 2.09h1.16V12.7H8.05v1.16zM12.7 15.95h1.16c1.15 0 2.09-.94 2.09-2.09V12.7H12.7v3.25z"/>
  ...
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14 7h-4c-1.65 0-3 1.35-3 3v4c0 1.65 1.35 3 3 3h4c1.65 0 3-1.35 3-3v-4M12 7v10M7 12h10"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2 12.98V15c0 5 2 7 7 7h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9"/>`
  },
  bulk: {
    viewBox: '0 0 24 24',
  ...
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10 3L8 21M16 3l-2 18M3.5 9h18M2.5 15h18"/>`
  },
  outline: {
    viewBox: '0 0 24 24',
  ...
  <path d="M14 17.75h-4c-2.07 0-3.75-1.68-3.75-3.75v-4c0-2.07 1.68-3.75 3.75-3.75h4c2.07 0 3.75 1.68 3.75 3.75v4c0 2.07-1.68 3.75-3.75 3.75zm-4-10c-1.24 0-2.25 1.01-2.25 2.25v4c0 1.24 1.01 2.25 2.25 2.25h4c1.24 0 2.25-1.01 2.25-2.25v-4c0-1.24-1.01-2.25-2.25-2.25h-4z"/>
  <path d="M12 17.75c-.41 0-.75-.34-.75-.75V7c0-.41.34-.75.75-.75s.75.34.75.75v10c0 .41-.34.75-.75.75z"/>
  <path d="M17 12.75H7c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h10c.41 0 .75.34.75.75s-.34.75-.75.75z"/>`
  },
  twotone: {
    viewBox: '0 0 24 24',
