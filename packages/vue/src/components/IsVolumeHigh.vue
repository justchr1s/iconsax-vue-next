...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M18 16.75a.75.75 0 01-.6-1.2 5.94 5.94 0 000-7.1.75.75 0 011.2-.9c1.96 2.62 1.96 6.28 0 8.9-.15.2-.37.3-.6.3z"/>
  ...
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 7.41c0-2.98-2.07-4.12-4.59-2.54L7.49 6.7c-.32.19-.69.3-1.06.3H5c-2 0-3 1-3 3v4c0 2 1 3 3 3h1.43c.37 0 .74.11 1.06.3l2.92 1.83c2.52 1.58 4.59.43 4.59-2.54v-5.12M18 8a6.66 6.66 0 010 8M19.83 18.5C21.28 16.57 22 14.29 22 12M19.83 5.5c.59.78 1.05 1.62 1.4 2.5"/>`,
    isStroke: true
  },
  bulk: {
    viewBox: '0 0 24 24',
  ...
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-width="1.5" d="M2 10v4c0 2 1 3 3 3h1.43c.37 0 .74.11 1.06.3l2.92 1.83c2.52 1.58 4.59.43 4.59-2.54V7.41c0-2.98-2.07-4.12-4.59-2.54L7.49 6.7c-.32.19-.69.3-1.06.3H5c-2 0-3 1-3 3z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18 8a6.66 6.66 0 010 8M19.83 5.5a10.83 10.83 0 010 13"/>`,
    isStroke: true
  },
  outline: {
    viewBox: '0 0 24 24',
