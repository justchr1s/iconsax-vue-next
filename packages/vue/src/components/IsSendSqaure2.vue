...
const svgData = {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M10.59 7.68h4.24v4.25M14.83 7.68l-5.66 5.66M6 16.51c3.89 1.3 8.11 1.3 12 0"/>`,
    isStroke: true
  },
  bulk: {
    viewBox: '0 0 24 24',
  ...
  <path d="M14.83 12.68c-.41 0-.75-.34-.75-.75V8.44h-3.49c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h4.24c.41 0 .75.34.75.75v4.24c0 .41-.34.75-.75.75z"/>
  <path d="M9.17 14.09c-.19 0-.38-.07-.53-.22a.754.754 0 010-1.06l5.66-5.66c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06L9.7 13.87c-.14.15-.34.22-.53.22zM12 18.23c-2.11 0-4.23-.34-6.24-1.01a.753.753 0 01-.47-.95c.13-.39.56-.61.95-.47 3.72 1.24 7.81 1.24 11.53 0 .39-.13.82.08.95.47.13.39-.08.82-.47.95-2.02.68-4.14 1.01-6.25 1.01z"/>`,
    isStroke: false
  },
  twotone: {
    viewBox: '0 0 24 24',
