...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M11.252 8.078v2.86l-1.01-.35c-.51-.18-.82-.35-.82-1.22 0-.71.53-1.29 1.18-1.29h.65zM14.58 14.629c0 .71-.53 1.29-1.18 1.29h-.65v-2.86l1.01.35c.51.18.82.35.82 1.22z"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2 9c0-5 2-7 7-7h6c5 0 7 2 7 7v6c0 5-2 7-7 7H9c-5 0-7-2-7-7v-1.97"/>`,
    isStroke: true
  },
  bulk: {
    viewBox: '0 0 24 24',
