...
const svgData = {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 10h-4c-3 0-4-1-4-4V2l8 8zM7 13h6M7 17h4"/>`
  },
  outline: {
    viewBox: '0 0 24 24',
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 13h6M7 17h4" opacity=".4"/>`
  }
}
