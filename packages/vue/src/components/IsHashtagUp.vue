...
const svgData = {
  ...
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2 13.04V15c0 5 2 7 7 7h6M22 13V9c0-5-2-7-7-7H9C4 2 2 4 2 9M19 22v-6l-2 2M19 16l2 2M9.95 6.26L8.9 15.73M13.11 6.26l-1.05 9.47M6.53 9.42H16M6 12.58h9.47"/>`
  },
  bulk: {
    viewBox: '0 0 24 24',
  ...
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 13V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h6"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 22v-6l-2 2M19 16l2 2M9.95 6.26L8.9 15.73M13.11 6.26l-1.05 9.47M6.53 9.42H16M6 12.58h9.47"/>`
  },
  outline: {
    viewBox: '0 0 24 24',
    content: `<path d="M15 22.75H9c-5.43 0-7.75-2.32-7.75-7.75V9c0-5.43 2.32-7.75 7.75-7.75h6c5.43 0 7.75 2.32 7.75 7.75v4c0 .41-.34.75-.75.75s-.75-.34-.75-.75V9c0-4.61-1.64-6.25-6.25-6.25H9C4.39 2.75 2.75 4.39 2.75 9v6c0 4.61 1.64 6.25 6.25 6.25h6c.41 0 .75.34.75.75s-.34.75-.75.75z"/>
  <path d="M19 22.75c-.41 0-.75-.34-.75-.75v-4.19l-.72.72c-.29.29-.77.29-1.06 0a.754.754 0 010-1.06l2-2a.751.751 0 011.28.53v6c0 .41-.34.75-.75.75z"/>
  <path d="M21 18.75c-.19 0-.38-.07-.53-.22l-2-2a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l2 2c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22zM8.9 16.49h-.08a.751.751 0 01-.66-.83L9.2 6.18c.05-.41.42-.71.83-.66.41.05.71.42.66.83l-1.05 9.47c-.04.38-.37.67-.74.67zM12.05 16.49h-.08a.751.751 0 01-.66-.83l1.05-9.47c.05-.41.42-.71.83-.66.41.05.71.42.66.83l-1.05 9.47c-.04.37-.37.66-.75.66z"/>
