...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M14 2.92v8.31c0 1.02-.83 1.85-1.85 1.85H3c-.55 0-1-.45-1-1V5.69C2 3.65 3.65 2 5.69 2h7.38c.52 0 .93.41.93.92z"/>
  <path d="M21.5 15.5c.28 0 .5.22.5.5v1c0 1.66-1.34 3-3 3 0-1.65-1.35-3-3-3s-3 1.35-3 3h-2c0-1.65-1.35-3-3-3s-3 1.35-3 3c-1.66 0-3-1.34-3-3v-2c0-.55.45-1 1-1h9.5a2.5 2.5 0 002.5-2.5V6c0-.55.45-1 1-1h.84c.72 0 1.38.39 1.74 1.01l.64 1.12c.09.16-.03.37-.22.37a2.5 2.5 0 00-2.5 2.5v3a2.5 2.5 0 002.5 2.5h2.5z"/>
  <path d="M8 22a2 2 0 100-4 2 2 0 000 4zM16 22a2 2 0 100-4 2 2 0 000 4zM22 12.53V14h-3c-.55 0-1-.45-1-1v-3c0-.55.45-1 1-1h1.29l1.45 2.54c.17.3.26.64.26.99z"/>`,
    isStroke: false
  },
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2 6c0-2.21 1.79-4 4-4h9v10c0 1.1-.9 2-2 2H2v-3.01"/>
  ...
  outline: {
    viewBox: '0 0 24 24',
    content: `<path d="M13 14.75H2c-.41 0-.75-.34-.75-.75V6c0-2.62 2.13-4.75 4.75-4.75h9c.41 0 .75.34.75.75v10c0 1.52-1.23 2.75-2.75 2.75zm-10.25-1.5H13c.69 0 1.25-.56 1.25-1.25V2.75H6C4.21 2.75 2.75 4.21 2.75 6v7.25z"/>
  ...
  twotone: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 2v10c0 1.1-.9 2-2 2H2V6c0-2.21 1.79-4 4-4h9z" opacity=".4"/>
