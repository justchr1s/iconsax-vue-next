...
const svgData = {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9 19c0 .75-.21 1.46-.58 2.06-.21.36-.48.68-.79.94-.7.63-1.62 1-2.63 1a3.97 3.97 0 01-3.42-1.94A3.92 3.92 0 011 19c0-1.26.58-2.39 1.5-3.12A3.999 3.999 0 019 19zM6.49 18.98H3.51M5 17.52v2.99"/>
  ...
  bulk: {
    viewBox: '0 0 25 24',
    content: `<path d="M19.942 12.605h1.966v-1.402a3.668 3.668 0 00-3.66-3.66H7.074a3.668 3.668 0 00-3.66 3.66v4.254a3.892 3.892 0 016.327 3.037c0 .73-.205 1.42-.565 2.005-.204.35-.467.662-.769.915h9.84a3.668 3.668 0 003.66-3.66v-1.158h-1.849c-1.05 0-2.014-.77-2.102-1.82a1.955 1.955 0 01.584-1.587 1.94 1.94 0 011.402-.584z" opacity=".4"/>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M9 19c0 .75-.21 1.46-.58 2.06-.21.36-.48.68-.79.94-.7.63-1.62 1-2.63 1a3.97 3.97 0 01-3.42-1.94A3.92 3.92 0 011 19c0-1.26.58-2.39 1.5-3.12A3.999 3.999 0 019 19zM6.492 18.98h-2.98M5 17.52v2.99"/>`
  },
  outline: {
    viewBox: '0 0 24 24',
  ...
  <path d="M6.49 19.73H3.5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h2.99a.749.749 0 110 1.5z"/>
