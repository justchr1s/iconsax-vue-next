...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M11.25 12.75V22H7.81C4.17 22 2 19.83 2 16.19v-3.44h9.25zM22 7.81v3.44h-9.25V2h3.44C19.83 2 22 4.17 22 7.81zM11.25 2v9.25H2V7.81C2 4.17 4.17 2 7.81 2h3.44zM22 12.75v3.44c0 3.64-2.17 5.81-5.81 5.81h-3.44v-9.25H22z"/>`,
    isStroke: false
  },
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3.96 3.32C2.6 4.43 2 6.27 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9M12 2v20M2 12h20"/>`,
    isStroke: true
  },
  bulk: {
    viewBox: '0 0 24 24',
    content: `<path d="M2 12h10v10H7.81C4.17 22 2 19.83 2 16.19V12zM22 7.81V12H12V2h4.19C19.83 2 22 4.17 22 7.81z" opacity=".4"/>
  <path d="M12 2v10H2V7.81C2 4.17 4.17 2 7.81 2H12zM22 12v4.19c0 3.64-2.17 5.81-5.81 5.81H12V12h10z"/>`,
    isStroke: false
  },
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM12 2v20M2 12h20"/>`,
    isStroke: true
  },
  outline: {
    viewBox: '0 0 24 24',
