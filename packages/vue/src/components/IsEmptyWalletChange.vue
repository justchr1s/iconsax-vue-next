...
const svgData = {
  ...
  bulk: {
    viewBox: '0 0 24 24',
    content: `<path d="M19.48 12.95h2.02v-1.44c0-2.07-1.69-3.76-3.76-3.76H6.26c-2.07 0-3.76 1.69-3.76 3.76v3.65c.79-.72 1.85-1.16 3-1.16a4.5 4.5 0 014.5 4.5c0 .53-.09 1.03-.26 1.5-.27.79-.77 1.47-1.4 2h9.4c2.07 0 3.76-1.69 3.76-3.76v-1.19h-1.9c-1.08 0-2.07-.79-2.16-1.87-.06-.63.18-1.22.6-1.63.37-.38.88-.6 1.44-.6z" opacity=".4"/>
