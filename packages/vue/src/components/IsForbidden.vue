...
const svgData = {
  ...
  <path d="M3.02 21.75c-.19 0-.38-.07-.53-.22a.754.754 0 010-1.06L20.47 2.49c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06L3.55 21.53a.71.71 0 01-.53.22z"/>`
  },
  linear: null,
  outline: {
    viewBox: '0 0 24 24',
  ...
  <path d="M4.939 19.83c-.19 0-.38-.07-.53-.22a.754.754 0 010-1.06l14.14-14.14c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06L5.469 19.61c-.15.15-.34.22-.53.22z"/>`
  },
  twotone: {
    viewBox: '0 0 24 24',
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4.94 19.08L19.08 4.94" opacity=".4"/>`
  }
}
