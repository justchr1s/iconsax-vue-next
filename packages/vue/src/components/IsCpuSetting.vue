...
const svgData = {
  ...
  outline: {
    viewBox: '0 0 24 24',
    content: `<path d="M9.6 20.75c-4.39 0-6.35-1.96-6.35-6.35V9.6c0-4.39 1.96-6.35 6.35-6.35h4.8c4.39 0 6.35 1.96 6.35 6.35 0 .41-.34.75-.75.75s-.75-.34-.75-.75c0-3.58-1.27-4.85-4.85-4.85H9.6c-3.58 0-4.85 1.27-4.85 4.85v4.8c0 3.58 1.27 4.85 4.85 4.85.41 0 .75.34.75.75s-.34.75-.75.75z"/>
  <path d="M7.99 17.1c-.16 0-.33-.05-.47-.16-.87-.69-1.28-1.79-1.28-3.44v-3c0-2.9 1.35-4.25 4.25-4.25h3c1.65 0 2.74.41 3.44 1.28.26.32.2.8-.12 1.05-.32.26-.8.21-1.05-.12-.24-.31-.74-.71-2.26-.71h-3c-2.08 0-2.75.67-2.75 2.75v3c0 1.52.41 2.02.71 2.26.32.26.38.73.12 1.05-.15.19-.37.29-.59.29zM8.01 4.75c-.42 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v2c0 .41-.34.75-.75.75zM12 4.75c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v2c0 .41-.34.75-.75.75zM16 4.75c-.41 0-.75-.34-.75-.75V2c0-.41.34-.75.75-.75s.75.34.75.75v2c0 .41-.34.75-.75.75zM22 8.75h-2c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h2a.749.749 0 110 1.5zM8.01 22.75c-.41 0-.75-.34-.75-.75v-2c0-.41.34-.75.75-.75s.75.34.75.75v2c0 .41-.34.75-.75.75zM4 8.75H2a.749.749 0 110-1.5h2a.749.749 0 110 1.5zM4 12.75H2c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h2a.749.749 0 110 1.5zM4 16.75H2c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h2a.749.749 0 110 1.5zM16.71 19.34c-1.29 0-2.34-1.05-2.34-2.34 0-1.29 1.05-2.34 2.34-2.34 1.29 0 2.34 1.05 2.34 2.34a2.35 2.35 0 01-2.34 2.34zm0-3.18c-.46 0-.84.38-.84.84 0 .46.38.84.84.84.46 0 .84-.38.84-.84a.852.852 0 00-.84-.84z"/>
  <path d="M18.4 22.75c-.56 0-1.11-.29-1.41-.81l-.07-.11c-.11-.19-.2-.24-.22-.25-.01 0-.11.06-.22.25l-.06.1a1.63 1.63 0 01-2.24.59l-.9-.52c-.41-.23-.7-.61-.82-1.07-.12-.45-.06-.93.17-1.33.11-.19.11-.3.1-.32-.01-.01-.1-.06-.32-.06-.97 0-1.76-.79-1.76-1.75v-.93c0-.97.79-1.75 1.75-1.75.22 0 .31-.06.33-.07 0-.01 0-.12-.11-.31-.23-.41-.3-.88-.17-1.33.12-.45.41-.83.82-1.07l.91-.53c.76-.45 1.77-.19 2.22.59l.06.11c.11.19.2.24.22.25.01 0 .11-.06.22-.25l.06-.1c.47-.79 1.47-1.05 2.24-.59l.93.51c.41.23.7.61.82 1.07.12.45.06.93-.17 1.33-.11.19-.11.3-.1.32.01.01.1.06.32.06.97 0 1.76.79 1.76 1.75v.93c0 .97-.79 1.75-1.75 1.75-.22 0-.31.06-.33.07 0 .01 0 .12.11.31.23.41.3.88.17 1.33-.12.45-.41.83-.82 1.07l-.91.53c-.27.15-.55.23-.83.23zm-1.69-2.67c.6 0 1.15.36 1.52 1l.06.11c.03.05.11.08.17.04l.92-.53c.08-.04.11-.12.12-.16.01-.04.02-.11-.02-.19-.37-.63-.4-1.29-.1-1.81.3-.52.89-.82 1.62-.82.14 0 .26-.12.26-.25v-.93c0-.14-.12-.25-.25-.25-.73 0-1.33-.3-1.62-.82-.3-.52-.26-1.18.1-1.81.05-.08.04-.16.02-.19a.267.267 0 00-.12-.16l-.91-.53c-.07-.04-.15-.01-.19.05l-.05.09c-.37.64-.92 1-1.52 1s-1.15-.36-1.52-1l-.06-.1c-.03-.06-.12-.08-.17-.05l-.92.53c-.08.04-.11.12-.12.16-.01.04-.02.11.02.19.37.63.4 1.29.1 1.81-.3.52-.89.82-1.62.82-.14 0-.26.12-.26.25v.93c0 .14.12.25.25.25.73 0 1.33.3 1.62.82.3.52.26 1.18-.1 1.81a.268.268 0 00.1.35l.91.53c.07.04.15.01.19-.05l.05-.1c.36-.63.92-.99 1.52-.99z"/>`,
    isStroke: false
  },
  twotone: {
    viewBox: '0 0 24 24',
