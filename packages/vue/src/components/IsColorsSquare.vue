...
const svgData = {
  ...
  outline: {
    viewBox: '0 0 24 24',
    content: `<path d="M9.6 18.75c-2.4 0-4.35-1.95-4.35-4.35 0-1.96 1.32-3.69 3.21-4.2.37-.1.75.09.89.45.33.83 1.04 1.47 1.9 1.7.47.13 1.03.13 1.5 0 .37-.1.76.09.9.44a4.37 4.37 0 01-1.15 4.84c-.79.72-1.82 1.12-2.9 1.12zm-1.31-6.88a2.85 2.85 0 00-1.54 2.53c0 1.57 1.28 2.85 2.85 2.85.7 0 1.38-.26 1.9-.73a2.822 2.822 0 00.91-2.59c-.53.05-1.07 0-1.56-.14a4.356 4.356 0 01-2.56-1.92z"/>
  <path d="M12 13.95c-.4 0-.79-.05-1.15-.15a4.373 4.373 0 01-2.89-2.59c-.2-.51-.3-1.05-.3-1.6 0-2.4 1.95-4.35 4.35-4.35 2.4 0 4.35 1.95 4.35 4.35 0 .55-.1 1.09-.3 1.6A4.341 4.341 0 0112 13.95zm0-7.2a2.855 2.855 0 00-2.65 3.9c.33.83 1.04 1.47 1.9 1.7.47.13 1.03.13 1.5 0 .87-.24 1.58-.87 1.9-1.7A2.855 2.855 0 0012 6.75z"/>
  <path d="M14.4 18.75c-1.08 0-2.11-.4-2.9-1.12a.75.75 0 010-1.12 2.82 2.82 0 00.75-3.16.762.762 0 01.5-1 2.88 2.88 0 001.9-1.7.75.75 0 01.89-.45c1.89.51 3.21 2.24 3.21 4.2 0 2.4-1.95 4.35-4.35 4.35zm-1.28-1.8a2.855 2.855 0 004.13-2.55c0-1.08-.61-2.05-1.54-2.53-.44.72-1.09 1.3-1.85 1.66a4.318 4.318 0 01-.74 3.42z"/>
  ...
  twotone: {
    ...
    <path d="M13.2 14.4c0 1.06-.46 2.02-1.2 2.68-.64.58-1.48.92-2.4.92a3.598 3.598 0 01-.95-7.07A3.61 3.61 0 0012 13.21c.33 0 .65-.04.95-.13.16.4.25.85.25 1.32z"/>
    <path d="M15.6 9.6c0 .47-.09.92-.25 1.33A3.61 3.61 0 0112 13.21c-.33 0-.65-.04-.95-.13A3.587 3.587 0 018.4 9.6C8.4 7.61 10.01 6 12 6s3.6 1.61 3.6 3.6z"/>
    <path d="M18 14.4a3.598 3.598 0 01-6 2.68 3.55 3.55 0 001.2-2.68c0-.47-.09-.92-.25-1.33 1.1-.3 1.99-1.1 2.4-2.15A3.62 3.62 0 0118 14.4z"/>
  </g>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7z"/>`
  }
}
