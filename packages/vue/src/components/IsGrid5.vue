...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M8.25 2v20h-.44C4.17 22 2 19.83 2 16.19V7.81C2 4.17 4.17 2 7.81 2h.44zM22 7.81v3.44H9.75V2h6.44C19.83 2 22 4.17 22 7.81zM22 12.75v3.44c0 3.64-2.17 5.81-5.81 5.81H9.75v-9.25H22z"/>`
  },
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 2v20M9 12h13M3.96 3.32C2.6 4.43 2 6.27 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9"/>`
  },
  bulk: {
    viewBox: '0 0 24 24',
    content: `<path d="M22 7.81V12H9V2h7.19C19.83 2 22 4.17 22 7.81z" opacity=".6"/>
  ...
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM10 2v20M10 12h12"/>`
  },
  outline: {
    viewBox: '0 0 24 24',
  ...
  <path d="M22 12.75H10c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h12c.41 0 .75.34.75.75s-.34.75-.75.75z"/>`
  },
  twotone: {
    viewBox: '0 0 24 24',
