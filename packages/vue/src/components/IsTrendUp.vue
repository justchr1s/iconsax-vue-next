...
const svgData = {
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M11.17 12l-.47-.7-3.2 3.2M16.5 9.5l-1.51 1.51L14 12M14.5 9.5h2v2"/>`
  },
  bulk: {
    viewBox: '0 0 24 24',
  ...
  <path d="M16.83 9.41a.707.707 0 00-.38-.38.751.751 0 00-.26-.05h-1.86c-.39 0-.7.31-.7.7 0 .39.31.7.7.7h.18l-2.11 2.11-1.02-1.52a.712.712 0 00-.51-.31.676.676 0 00-.56.2l-2.98 2.98c-.27.27-.27.71 0 .99.14.14.31.2.49.2s.36-.07.49-.2l2.38-2.38 1.02 1.52c.12.17.3.29.51.31.22.02.41-.05.56-.2l2.72-2.72v.18c0 .39.31.7.7.7.39 0 .7-.31.7-.7V9.67c-.02-.09-.03-.18-.07-.26z"/>`
  },
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16.5 9.5l-4.2 4.2-1.6-2.4-3.2 3.2"/>
  ...
  outline: {
    viewBox: '0 0 24 24',
    content: `<path d="M7.5 15.25c-.19 0-.38-.07-.53-.22a.754.754 0 010-1.06l3.2-3.2a.741.741 0 011.15.11l1.09 1.64 3.55-3.55c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-4.2 4.2a.741.741 0 01-1.15-.11l-1.09-1.64-2.55 2.55c-.15.15-.34.22-.53.22z"/>
  <path d="M16.5 12.25c-.41 0-.75-.34-.75-.75v-1.25H14.5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h2c.41 0 .75.34.75.75v2c0 .41-.34.75-.75.75z"/>
  ...
  twotone: {
    ...
    <path d="M16.5 9.5l-4.2 4.2-1.6-2.4-3.2 3.2"/>
