...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M16.19 2h-3.44v11.75H22V7.81C22 4.17 19.83 2 16.19 2zM2 10.25v5.94C2 19.83 4.17 22 7.81 22h3.44V10.25H2zM11.25 2v6.75H2v-.94C2 4.17 4.17 2 7.81 2h3.44zM22 15.25v.94c0 3.64-2.17 5.81-5.81 5.81h-3.44v-6.75H22z"/>`
  },
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 2v20M2 9.5h10M12 14.5h10M3.96 3.32C2.6 4.43 2 6.27 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9"/>`
  },
  bulk: {
    viewBox: '0 0 24 24',
    content: `<path d="M22 7.81v6.69H12V2h4.19C19.83 2 22 4.17 22 7.81z" opacity=".6"/>
  ...
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM12 2v20M2 9.5h10M12 14.5h10"/>`
  },
  outline: {
    viewBox: '0 0 24 24',
  ...
  <path d="M12 10.25H2c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h10c.41 0 .75.34.75.75s-.34.75-.75.75zM22 15.25H12c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h10c.41 0 .75.34.75.75s-.34.75-.75.75z"/>`
  },
  twotone: {
    viewBox: '0 0 24 24',
