...
const svgData = {
  ...
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M7.5 8.34h7.4c.89 0 1.6.72 1.6 1.6v1.77"/>
  ...
  outline: {
    viewBox: '0 0 24 24',
    content: `<path d="M16.5 12.47c-.41 0-.75-.34-.75-.75V9.95a.85.85 0 00-.85-.85H7.5c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h7.4c1.3 0 2.35 1.06 2.35 2.35v1.77c0 .41-.34.75-.75.75z"/>
  ...
  twotone: {
    ...
    <path d="M9.19 6.66L7.5 8.34l1.69 1.69M16.5 15.66H9.1c-.89 0-1.6-.72-1.6-1.6v-1.77"/>
    <path d="M14.81 17.34l1.69-1.68-1.69-1.69"/>
  </g>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/>`,
    isStroke: true
  }
