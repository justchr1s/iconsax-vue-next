...
const svgData = {
  ...
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8.97 2c3.55 0 6.48 2.64 6.93 6.07.05.3.07.61.07.93 0 3.87-3.13 7-7 7-.32 0-.63-.02-.93-.07A6.986 6.986 0 011.97 9c0-1.93.78-3.68 2.05-4.95"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21.97 15c0 3.87-3.13 7-7 7-3.55 0-6.48-2.64-6.93-6.07.3.05.61.07.93.07 3.87 0 7-3.13 7-7 0-.32-.02-.63-.07-.93 3.43.45 6.07 3.38 6.07 6.93zM14.12 14.12l1.31 1.29M16.97 12l-1-1M11.97 17l-1-1"/>`
  },
  bulk: {
    viewBox: '0 0 24 24',
    content: `<path d="M12.5 17.53a.71.71 0 01-.53.22c-.19 0-.38-.07-.53-.22l-1.59-1.59c.59-.07 1.16-.21 1.69-.43l.96.96c.3.29.3.77 0 1.06zM15.96 15.93c-.14.15-.34.23-.53.23s-.38-.08-.53-.22l-1.53-1.5c.39-.31.75-.67 1.06-1.07l1.52 1.5c.3.29.3.77.01 1.06zM17.5 12.53a.71.71 0 01-.53.22c-.19 0-.38-.07-.53-.22l-.96-.96c.22-.53.36-1.1.43-1.69l1.59 1.59c.3.29.3.77 0 1.06z"/>
  <path d="M15.9 8.07A6.986 6.986 0 008.97 2c-3.87 0-7 3.13-7 7 0 3.55 2.64 6.48 6.07 6.93a6.397 6.397 0 001.81.01l-.38-.38a.754.754 0 010-1.06c.29-.3.77-.3 1.06 0l1.01 1.01c.67-.26 1.28-.62 1.83-1.07l-.9-.89a.745.745 0 010-1.06c.29-.29.76-.3 1.06-.01l.9.89c.44-.54.8-1.14 1.05-1.8l-1.01-1.01a.754.754 0 010-1.06c.29-.3.77-.3 1.06 0l.38.38a6.397 6.397 0 00-.01-1.81z"/>
  <path d="M21.97 15c0 3.87-3.13 7-7 7-3.55 0-6.48-2.64-6.93-6.07a6.397 6.397 0 001.81.01l1.59 1.59c.15.15.34.22.53.22.2 0 .39-.07.53-.22.3-.29.3-.77 0-1.06l-.96-.96c.67-.26 1.28-.62 1.83-1.07l1.53 1.5c.15.14.34.22.53.22s.39-.08.53-.23c.29-.29.29-.77-.01-1.06l-1.52-1.5c.44-.54.8-1.14 1.05-1.8l.96.96c.15.15.34.22.53.22.2 0 .39-.07.53-.22.3-.29.3-.77 0-1.06l-1.59-1.59a6.397 6.397 0 00-.01-1.81c3.43.45 6.07 3.38 6.07 6.93z" opacity=".4"/>`
  },
  linear: {
    viewBox: '0 0 22 22',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M14.97 8c0 3.87-3.13 7-7 7-.32 0-.63-.02-.93-.07A6.986 6.986 0 01.97 8c0-3.87 3.13-7 7-7 3.55 0 6.48 2.64 6.93 6.07.05.3.07.61.07.93z"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20.97 14c0 3.87-3.13 7-7 7-3.55 0-6.48-2.64-6.93-6.07.3.05.61.07.93.07 3.87 0 7-3.13 7-7 0-.32-.02-.63-.07-.93 3.43.45 6.07 3.38 6.07 6.93zM13.12 13.12l1.31 1.29M15.97 11l-1-1M10.97 16l-1-1"/>`
  },
  outline: {
    viewBox: '0 0 24 24',
    content: `<path d="M8.97 16.75c-.39 0-.73-.03-1.05-.08-3.8-.5-6.7-3.8-6.7-7.67 0-4.27 3.48-7.75 7.75-7.75 3.87 0 7.17 2.89 7.67 6.72.05.3.08.64.08 1.03 0 4.27-3.47 7.75-7.75 7.75zm0-14c-3.45 0-6.25 2.8-6.25 6.25a6.26 6.26 0 005.42 6.19c.26.04.53.06.83.06 3.45 0 6.25-2.8 6.25-6.25 0-.3-.02-.57-.06-.81a6.254 6.254 0 00-6.19-5.44z"/>
