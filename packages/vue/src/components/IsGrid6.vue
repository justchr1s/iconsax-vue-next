...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M22 7.75H9.75v-5.8h6.44c3.64 0 5.81 2.17 5.81 5.8zM22 16.25c-.05 3.57-2.21 5.7-5.81 5.7H9.75v-5.7H22zM8.25 1.95v20h-.44C4.17 21.95 2 19.78 2 16.14V7.76c0-3.64 2.17-5.81 5.81-5.81h.44zM22 9.25H9.75v5.5H22v-5.5z"/>`,
    isStroke: false
  },
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 2v20M9 8.5h13M9 15.5h13M3.96 3.32C2.6 4.43 2 6.27 2 9v6c0 5 2 7 7 7h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9"/>`,
    isStroke: true
  },
  bulk: {
    viewBox: '0 0 24 24',
    content: `<path d="M22 7.81v.69H9V2h7.19C19.83 2 22 4.17 22 7.81zM22 15.5v.69c0 3.64-2.17 5.81-5.81 5.81H9v-6.5h13z" opacity=".4"/>
  <path d="M9 2v20H7.81C4.17 22 2 19.83 2 16.19V7.81C2 4.17 4.17 2 7.81 2H9z"/>
  <path d="M22 8.5H9v7h13v-7z" opacity=".6"/>`,
    isStroke: false
  },
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 22h6c5 0 7-2 7-7V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7zM10 2v20M10 8.5h12M10 15.5h12"/>`,
    isStroke: true
  },
  outline: {
    viewBox: '0 0 24 24',
