...
const svgData = {
  ...
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.5 10.65h-5M12 8.21v5"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3.32 10.04v9.91c0 1.8 1.29 2.56 2.87 1.69l4.88-2.71c.52-.29 1.36-.29 1.87 0l4.88 2.71c1.58.88 2.87.12 2.87-1.69V5.86c0-2.12-1.74-3.86-3.86-3.86H7.18C5.05 2 3.32 3.74 3.32 5.86"/>`
  },
  bulk: {
    viewBox: '0 0 24 24',
  ...
  <path d="M14.5 9.9h-1.75V8.21c0-.41-.34-.75-.75-.75s-.75.34-.75.75V9.9H9.5c-.41 0-.75.34-.75.75s.34.75.75.75h1.75v1.81c0 .41.34.75.75.75s.75-.34.75-.75V11.4h1.75c.41 0 .75-.34.75-.75s-.34-.75-.75-.75z"/>`
  },
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="M14.5 10.65h-5M12 8.21v5"/>
  ...
  <path d="M12 13.96c-.41 0-.75-.34-.75-.75v-5c0-.41.34-.75.75-.75s.75.34.75.75v5c0 .41-.34.75-.75.75z"/>
