...
const svgData = {
  bold: {
    viewBox: '0 0 24 24',
    content: `<path d="M10.08 11.832h1.65l.19-1.66h-1.65l-.19 1.66z"/>
  ...
  broken: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M2 12.95V15c0 5 2 7 7 7h5M22 13V9c0-5-2-7-7-7H9C4 2 2 4 2 9M19 16v6l2-2M19 22l-2-2M9.95 6.26L8.9 15.73M13.11 6.26l-1.05 9.47M6.53 9.42H16M6 12.58h9.47"/>`
  },
  bulk: {
    viewBox: '0 0 24 24',
  ...
  <path d="M16 10.17c.41 0 .75-.34.75-.75s-.34-.75-.75-.75h-2.41l.26-2.32a.751.751 0 00-.66-.83.758.758 0 00-.83.66l-.28 2.49h-1.65l.26-2.32a.751.751 0 00-.66-.83.751.751 0 00-.83.66l-.28 2.49h-2.4c-.41 0-.75.34-.75.75s.34.75.75.75h2.23l-.18 1.66H6c-.41 0-.75.34-.75.75s.34.75.75.75h2.41l-.26 2.32c-.05.41.25.78.66.83h.08c.38 0 .7-.28.74-.67l.28-2.49h1.65l-.26 2.32c-.05.41.25.78.66.83h.08c.38 0 .7-.28.74-.67l.28-2.49h2.4c.41 0 .75-.34.75-.75s-.34-.75-.75-.75h-2.23l.18-1.66H16v.02zm-4.27 1.66h-1.65l.18-1.66h1.65l-.18 1.66z"/>`
  },
  linear: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 13V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h5"/>
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 16v6l2-2M19 22l-2-2M9.95 6.26L8.9 15.73M13.11 6.26l-1.05 9.47M6.53 9.42H16M6 12.58h9.47"/>`
  },
  outline: {
    viewBox: '0 0 24 24',
    content: `<path d="M14 22.75H9c-5.43 0-7.75-2.32-7.75-7.75V9c0-5.43 2.32-7.75 7.75-7.75h6c5.43 0 7.75 2.32 7.75 7.75v4c0 .41-.34.75-.75.75s-.75-.34-.75-.75V9c0-4.61-1.64-6.25-6.25-6.25H9C4.39 2.75 2.75 4.39 2.75 9v6c0 4.61 1.64 6.25 6.25 6.25h5c.41 0 .75.34.75.75s-.34.75-.75.75z"/>
  <path d="M19 22.75a.753.753 0 01-.75-.75v-6c0-.41.34-.75.75-.75s.75.34.75.75v4.19l.72-.72c.29-.29.77-.29 1.06 0 .29.29.29.77 0 1.06l-2 2c-.14.14-.34.22-.53.22z"/>
  <path d="M19 22.75c-.19 0-.38-.07-.53-.22l-2-2a.754.754 0 010-1.06c.29-.29.77-.29 1.06 0l2 2c.29.29.29.77 0 1.06-.15.15-.34.22-.53.22zM8.9 16.49h-.08a.751.751 0 01-.66-.83L9.2 6.18c.05-.41.41-.71.83-.66.41.05.71.42.66.83l-1.05 9.47c-.04.38-.37.67-.74.67zM12.05 16.49h-.08a.751.751 0 01-.66-.83l1.05-9.47c.05-.41.42-.71.83-.66.41.05.71.42.66.83l-1.05 9.47c-.04.37-.37.66-.75.66z"/>
  <path d="M16 10.17H6.53c-.41 0-.75-.34-.75-.75s.34-.75.75-.75H16c.41 0 .75.34.75.75s-.34.75-.75.75zM15.47 13.33H6c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h9.47a.749.749 0 110 1.5z"/>`
  },
  twotone: {
    viewBox: '0 0 24 24',
    content: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 13V9c0-5-2-7-7-7H9C4 2 2 4 2 9v6c0 5 2 7 7 7h5"/>
